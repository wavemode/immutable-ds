	...
	public function new() {
        ...
        describe("iterator", {
            ...
            it("should iterate in array order", {
                ...
                for (v in two) v.should.be(iter.next());

            });

            it("should iterate in insertion order", {

                for (v in three) v.should.be(iter.next());
        ...
        describe("values", {
            ...
            it("should iterate in array order", {
                ...
                for (v in two.values()) v.should.be(iter.next());

            });

            it("should iterate in insertion order", {

                for (v in three.values()) v.should.be(iter.next());
        ...
        describe("forWhile", {
            ...
            it("should stop executing when sideEffect returns false", {
                ...
                one.forWhile(x -> { i += x; i < 10; }).should.be(4);
                i.should.be(10);
