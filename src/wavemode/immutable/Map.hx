...
class Map<K, V> {
    ...
    static function fromArray<K, V>(arr : Array<{key: K, value: V}>) : Map<K, V> {
        var map = new Map<K, V>();
        arr.reverse();
        map.data = arr;
        return map;
    ...
    **/
    ...
    /**
        ...
        ```haxe
        Map.fromMap(["a" => 10, "b" => 5])
        ```
    **/
    public static macro function from<K, V>(expr : Expr) : ExprOf<Map<K, V>> {
        var names = [], exprs = [];
        switch expr.expr {
    ...
    **/
    public static function fromMap<K, V>(map : haxe.ds.Map<K, V>) : Map<K, V> {
    ...
    **/
    public function set(key: K, newValue: V): Map<K, V> {
        ...
        if (insert) arr.insert(0, {key: key, value: newValue});
    ...
    /**
        ...
        efficient.
    **/
    public function setAll(keys: Iterable<K>, values: Iterable<V>): Map<K, V> {
    ...
    **/
    public function remove(key: K): Map<K, V> {
        var i = 0, arr = data;
        for (k => v in this) {
            if (key == k) {
    ...
    **/
    public function removeValue(value : V): Map<K, V> {
        var i = 0, arr = data;
        for (v in this) {
            if (value == v) {
                arr = arr.slice(0, i).concat(arr.slice(i + 1));
    ...
    /**
        ...
        efficient.
    **/
    public function removeAll(keys: Iterable<K>) : Map<K, V> {
        var map = this;
        for (key in keys) {
            map = map.remove(key);
        }
    ...
    /**
        ...
        efficient.
    **/
    public inline function removeAllValues(values : Iterable<V>): Map<K, V> {
        var map = this;
    ...
    **/
    public function clear() : Map<K, V> { // TODO: implement
        return fromArray([]);
    }
    ...
    **/
    ...
    /**
        ...
        efficient.
    **/
    public function mergeAll(others : Iterable<Map<K, V>>, ?mergeFunction : (V, V) -> V) : Map<K, V> { // TODO: implement
        var result = this;
    ...
    **/
    public function map<M>(mapper: V -> M): Map<K, M> {
    ...
    **/
    public function mapWithKey<M>(mapper: (K, V) -> M): Map<K, M> {
    ...
    **/
    public function mapEntries<MK, MV>(mapper: (K, V) -> {key: MK, value: MV}): Map<MK, MV> {
    ...
    **/
    public function filter(predicate: V -> Bool) : Map<K, V> {
    ...
    **/
    public function filterWithKey(predicate: (K, V) -> Bool) : Map<K, V> {
    ...
    **/
    public function equals(other: Map<K, V>): Bool {
    ...
    **/
    ...
    /**
        Converts this Map to an OrderedMap.
    **/
    public function toOrderedMap() : OrderedMap<K, V> { // TODO: implement
       return null;
